...
FilterDL_VXDB.Parameters = {
                            ...
                            "InputCollection": ["VXDTrackerHits"],
                            "OutputCollection": ["VXDTrackerHits_DLFiltered"],
...
FilterDL_VXDE.Parameters = {
                            ...
                            "FillHistograms": ["false"],
                            "InputCollection": ["VXDEndcapTrackerHits"],
                            "OutputCollection": ["VXDEndcapTrackerHits_DLFiltered"],
                            "SubDetectorName": ["Vertex"]
                            }
algList.append(FilterDL_VXDE)

ConformalTrackingILC = MarlinProcessorWrapper("ConformalTrackingILC")
ConformalTrackingILC.OutputLevel = INFO
ConformalTrackingILC.ProcessorType = "ConformalTrackingV2"
ConformalTrackingILC.Parameters = {
                                   "DebugHits": ["DebugHits"],
                                   "DebugPlots": ["false"],
                                   "DebugTiming": ["true"],
                                   ...
                                   "Steps": [
                                        ...
                                        "[VXDALL]",
                                            "@Collections", ":",
                                                "VXDTrackerHits_DLFiltered,", "VXDEndcapTrackerHits_DLFiltered",
                                            "@Parameters", ":",
                                                "MaxCellAngle", ":", "0.025;",
                                                "MaxCellAngleRZ", ":", "0.025;",
                                                "Chi2Cut", ":", "100;",
...
algList.append(ConformalTrackingILC)
